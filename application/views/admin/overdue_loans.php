...
<div class="content-wrapper">
    <section class="content-title">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-home"></i>Overdue Loans</a></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-info" style="min-height: 150px;">
                    <div class="panel-heading"><i class="fa fa-plus"></i> Overdue Loans</div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        foreach ($borrowdetails as $details){
                                            ?>
                                            <?php
                                            //if($details['paid_amount'] < $details['expected_amount']){
                                                ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo number_format($details['paid_amount'],2);?></td>
                                                    <td style="font-weight: bold; color: red;"><?php echo number_format($details['expected_amount']-$details['paid_amount'],2);?></td>
                                                </tr>
                                                <?php
                                            //}
                                            ?>
