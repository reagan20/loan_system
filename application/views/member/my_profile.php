        ...
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-primary">
                    <div class="panel-heading"><i class="fa fa-paw"></i> Personal Details</div>
                    <div class="panel-body">
                        <form method="post" action="<?php// echo site_url('System/updateAdminDetails/'.$admin_id);?>">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Membership No.:</label>
                                    <input readonly value="<?php echo $member_id;?>" class="form-control" placeholder="Membership Number">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="gender">
                                        ...
                                        foreach($gender as $g){
                                            ?>
                                            <option value="<?php echo $g['gender_id'];?>" <?php if($gend==$g['gender_id']) echo 'selected="selected"'?>><?php echo $g['gender_name'];?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <label>Role:</label>
                                    <input value="<?php echo $role;?>" type="text" class="form-control" name="role" required placeholder="Role">
                                </div>
                            </div><br/>
                            <!--<div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="updateadmin_btn" class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Save Update</button>
                                </div>
                            </div>-->
                        </form>
                    </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="<?php echo site_url('Member_controller/updatePassword/'.$member_id);?>">
                                    <div class="row">
                                        <div class="col-md-12">
