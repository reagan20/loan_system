...
<div class="content-wrapper">
    <section class="content-title">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href=""><i class="fa fa-user-plus"></i>New Contribution</a></li>
        </ol>
    </section>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <a href="<?php echo site_url('Member_controller/contributions');?>" class="btn btn-success btn-md"><i class="fa fa-refresh"></i> Refresh</a>
                            </div>
                        ...
                        <div class="modal fade" id="payment_modal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="<?php echo site_url('Member_controller/add_contribution')?>">
